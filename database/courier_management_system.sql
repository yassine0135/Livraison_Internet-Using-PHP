...
INSERT INTO `bran` (`livreur_id`, `B_Address`, `city`, `man_id`) VALUES
...
INSERT INTO `courier` (`cou_id`, `type`, `weight`, `cus_id`, `livreur_id`) VALUES
...
ALTER TABLE `courier`
  ...
  ADD CONSTRAINT `courier_ibfk_2` FOREIGN KEY (`livreur_id`) REFERENCES `bran` (`livreur_id`) ON DELETE CASCADE ON UPDATE CASCADE;
